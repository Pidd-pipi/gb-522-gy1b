...
type FiberRoute struct {
	...
	RouteStatus     constants.RouteStatus `gorm:"size:24;not null;default:active;check:route_status_allowed,route_status IN ('active','maintenance','retired')" json:"route_status"`
